...
test("root help is compact and every command is discoverable through immediate children", () => {
  ...
  assert.deepEqual(discovered.sort(), [
    ...
    "ads campaigns preview",
    "ads campaigns activate",
    "ads campaigns pause",
    "ads campaigns resume",
    "ads campaigns accept-rates",
    "ads reviews list",
    "ads reviews approve",
    "ads reviews reject",
    "ads reviews show",
    "ads reports spend",
    "ads reports delivery",
    "billing balance",
    "billing statement",
    "agent enroll",
    "agent connect",
    ...
    "screen schedule set",
    "screen schedule clear",
    "screen takeover set",
    "screen takeover clear",
    "screen reboot",
    "screen display set",
    "screen display clear",
    "screen display-schedule show",
    "screen display-schedule set",
    "screen display-schedule clear",
    "webhooks create",
    "webhooks list",
    "webhooks show",
    "webhooks update",
...
test("structured discovery exposes positional cardinality, choices, defaults and examples", () => {
  ...
  assert.deepEqual(init.arguments, [{ name: "inputs", description: "Local image/video/audio files, med_ IDs, rel_ IDs, or HTTPS URLs in playback order; audio becomes the soundtrack", required: true, variadic: true }]);
